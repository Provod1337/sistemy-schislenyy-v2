...
string system12 = Console.ReadLine();
foreach (char c in system12)
{
...
int system = Convert.ToInt32(system12);
...
string system22 = Console.ReadLine();
foreach (char c in system22)
{
    if (c == '0' || c == '1' || c == '2' || c == '3' || c == '4' || c == '5' || c == '6' || c == '7' || c == '8' || c == '9')
    {
    }
...
int system2 = Convert.ToInt32(system22);
